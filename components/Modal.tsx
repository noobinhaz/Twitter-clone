...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800 bg-opacity-70">
      <div className="relative w-4 lg:w-3/6 my-6 mx-auto lg:max-w-3xl h-full lg:h-auto">
        {/**Content */}
        <div className="h-full lg:h-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-black outline-none focus:outline-none">
          ...
          <div className="flex flex-col gap-2 p-10">
            <Button disabled={disbaled} secondary label={actionLabel} fullWidth large onclick={handleSubmit}/>
            {footer}
          </div>
        </div>
      </div>
